...
// TODO - expand m_jDisplay HTML functionality        
    ...
    private Double getCostPrice()
    {
        try
        {
            Double costPrice = (Double)Formats.DOUBLE.parseValue(m_jPriceBuy.getText())/100d;
            return costPrice;
        }
    ...
    private void setExternalRef(Object value)
    {
        try
        {
            ...
            m_jPriceBuy.setText(String.valueOf(extRefPence));     
        }
        catch (Exception ex)
        {
    ...
    private void initComponents() {
        ...
        jLabel19.setBounds(240, 210, 70, 25);
        ...
        m_jmargin.setEnabled(false);
        jPanel2.add(m_jmargin);
        m_jmargin.setBounds(370, 210, 70, 25);

        jLabel22.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel22.setText(bundle.getString("label.grossprofit")); // NOI18N
        jPanel2.add(jLabel22);
        jLabel22.setBounds(240, 240, 90, 20);
        ...
        jPanel2.add(m_jGrossProfit);
        m_jGrossProfit.setBounds(370, 240, 70, 25);
        ...
        jPanel2.add(m_jVerpatrib);
        m_jVerpatrib.setBounds(350, 280, 120, 23);
        ...
        jPanel2.add(m_jCheckWarrantyReceipt);
        m_jCheckWarrantyReceipt.setBounds(20, 300, 310, 23);
        ...
        jPanel4.add(m_jTitle);
        m_jTitle.setBounds(300, 0, 240, 20);
    ...
    private void categorySelected(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_categorySelected
            ...
            if (evt.getStateChange() == ItemEvent.SELECTED && addingNew) {
                ...
                try {  
                   ...
                   CategoryInfo cInfo = (CategoryInfo)m_CategoryModel.getSelectedItem();
                   shortCode = cInfo.getShortCode();
                } catch (BasicException ex) {}
