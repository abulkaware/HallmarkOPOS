...
CREATE TABLE CUSTOMERS (
    ...
    RECEIVESMS BIT DEFAULT b'1' NOT NULL,
    RECEIVEEMAIL BIT DEFAULT b'1' NOT NULL,
    RECEIVEPOST BIT DEFAULT b'1' NOT NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE CATEGORIES (
    ...
    CATSHORTCODE VARCHAR(255) DEFAULT '' NOT NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE PRODUCTS (
    ...
    SEQUENCEID INT DEFAULT 0 NOT NULL,
    ...
    CONSTRAINT PRODUCTS_SUPP_FK FOREIGN KEY (SUPPLIERID) REFERENCES SUPPLIERS(ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
